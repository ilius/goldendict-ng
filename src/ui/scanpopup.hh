...
class ScanPopup: public QMainWindow, KeyboardState {
  ...
  public:
	...
	ScanPopup(QWidget * parent, Config::Class & cfg, ArticleNetworkAccessManager &, AudioPlayerPtr const &, std::vector<sptr<Dictionary::Class>> const & allDictionaries, Instances::Groups const &, History &);
  ...
  private:
	...
	bool
	isWordPresentedInFavorites(QString const & word, unsigned groupId) const;
	...
	QString
		translateBoxSuffix; ///< A punctuation suffix that corresponds to translateBox's text.
